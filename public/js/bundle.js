...
function _updateData() {
  _updateData = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, type) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            res = _context.sent;
            (0, _alert.showAlert)('success', 'Data updated succesfully!');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZmFzYW5vc2FsdmF0b3JlIiwiYSI6ImNrZHp0NmhkdDF4cGszMHNncnhwNXYzcDIifQ.8T9YrtkfrrwJ9bjk-aNhPw';
...
var stripe = Stripe('pk_test_51HIzBoHwh5DpPeOTGCg1mipAHYTWXxT9vumpWJpkDovI2hvpaRi4iltawQ01Gr2mM38C2V8z1WwyWonvT8y7B1zu00d5pIkqiq');
...
if (document.querySelector('#login .form')) document.querySelector('#login .form').addEventListener('submit', function (e) {
  e.preventDefault();
  var email = document.getElementById('email').value;
  var password = document.getElementById('password').value;
  (0, _auth.login)(email, password);
});
if (document.querySelector('#signup .form')) document.querySelector('#signup .form').addEventListener('submit', function (e) {
  e.preventDefault();
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            res = _context.sent;
            document.querySelector('.form__user-photo').src = "img/users/".concat(res.data.data.user.photo);
            document.querySelector('.nav__user-img').src = "img/users/".concat(res.data.data.user.photo);
...
if (document.querySelector('.form.form-user-settings')) document.querySelector('.form.form-user-settings').addEventListener('submit', /*#__PURE__*/function () {
...
if (document.getElementById('book-tour')) {
  var _require = require('./stripePayments'),
      bookTour = _require.bookTour;
