...
if (document.querySelector('.login-form .form')) document.querySelector('.login-form .form').addEventListener('submit', function (e) {
  e.preventDefault();
